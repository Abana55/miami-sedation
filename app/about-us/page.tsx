      ...
      <section>
        ...
        <div className={styles.doctorsRow}>
          <TeamMember
            ...
            position="Doctor of Dental Surgery"
            bio={[
              "Dr. Ramon Bana was born in La Habana, Cuba...",
              "Bana’s patients describe him as down-to-earth...",
              "Dr. Bana has continued his education for the past 33 years...",
            ]}
            isDoctor={true}
          ...
          <TeamMember
            ...
            position="Doctor of Dental Medicine"
            bio={[
              "Dr. Andrew Brattain was born and raised in Miami...",
              "Dr. Brattain and his wife Danielle began their professional careers...",
              "Dr. Brattain is very excited to join Dr. Bana and the team...",
            ]}
            isDoctor={true}
            className={styles.doctorProfile}
          />
