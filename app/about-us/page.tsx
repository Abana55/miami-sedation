...
export default function AboutPage() {
    return(
      ...
      <p>Our dental team is unlike any you’ve ever met in Miami. We value excellence in patient care, and it shows. We love to laugh and have a good time, but know when it’s time to get down to business. Our team is overflowing with passion and commitment. We hope you get to know us a little bit better here, and we can’t wait to get to know you!</p>
      
      <h2>Our Team</h2>
      <div className={styles.teamMember}>
        <img src="/path/to/dr-bana-image.jpg" alt="Dr. Ramon Bana"/>
        <div className={styles.teamText}>
          <h3>Dr. Ramon Bana</h3>
        <h3>Dr. Ramon Bana</h3>
        <p>Doctor of Dental Surgery/ Doctor of Life Improvement</p>
        <p>Dr. Bana’s patients describe him as down-to-earth, professional, and full of heart. He is talented and strives to make each patient leave the office feeling better than when they arrived. Patient comfort is his top priority, and patients say they feel like extended family. He is dedicated to his practice, patients, and team – and it shows. Dr. Bana loves coming to work because his work changes people for the better. Patients leave his care healthier, happier, and with brighter smiles.</p>
        <p>As a graduate of Marquette University, Dr. Bana has continued his education for the past 25 years ensuring he is bringing the best of the best to his patients. He promises excellence and does the work to make sure he delivers on that promise.</p>
      </div>
      </div>
      
      <div className={styles.teamMember}>
        <img src="/path/to/dr-brattain-image.jpg" alt="Dr. Andrew Brattain"/>
        <div className={styles.teamText}>
