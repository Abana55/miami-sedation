...
import styles from "./GumContouring.module.scss";
...
const GumContouringPage: React.FC = () => {
  ...
  return (
    <>
      ...
      <div
        className={`${commonStyles["service-page"]} ${styles["gumContouringPage"]}`}
      >
        {/* Header Section */}
        ...
        >
          ...
          <p className={commonStyles.servicePageText}>
            Gum contouring is a cosmetic dental procedure that reshapes the gum
            line to create a more balanced and symmetrical smile. It involves
            removing excess gum tissue or restoring receding gum lines to
        ...
        >
          ...
          <div className={commonStyles.benefitsContainer}>
            <div className={commonStyles.benefitCard}>
              ...
              <p>
                Achieve a balanced smile by correcting a "gummy" appearance or
                uneven gum line.
              </p>
            </div>
            <div className={commonStyles.benefitCard}>
              ...
              <p>
                Feel more confident in your smile with proportionate gums and
                teeth.
              </p>
            </div>
            <div className={commonStyles.benefitCard}>
        ...
        >
          <h2 className={commonStyles.servicePageSubheader}>
            Our Gum Contouring Procedure
          </h2>
          <p className={commonStyles.servicePageText}>
            The procedure involves using specialized tools or laser technology
            to carefully remove or reshape excess gum tissue. It's performed
            under local anesthesia to ensure your comfort. Our experienced team
            will guide you through each step, from consultation to recovery.
          </p>
        </section>
