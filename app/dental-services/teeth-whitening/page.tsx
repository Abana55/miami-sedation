      ...
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            entry.target.classList.add(styles["service-page__articles--visible"]);
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content="Teeth Whitening | Bana Dental Design" />
        <meta
          property="og:description"
          content="Learn about the professional teeth whitening services provided by Bana Dental Design. Achieve a brighter smile with our safe and effective teeth whitening options."
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://yourdomain.com/services/teeth-whitening" />
        <meta property="og:image" content="https://yourdomain.com/images/Teeth Whitening Karolina Grabowska.jpg" />
        <link rel="canonical" href="https://yourdomain.com/services/teeth-whitening" />
      </Head>
      <main className={`${styles["service-page"]} ${styles["service-page--cosmetic"]}`}>
        ...
        <section className={styles["service-page__content"]}>
          {/* Introduction */}
          <article
            className={styles["service-page__articles"]}
            ref={articleRef}
          >
            ...
            <section className={styles["service-page__text"]}>
              ...
              <div className={styles["service-page__image-inline"]}>
                <img src="/images/Teeth Whitening Karolina Grabowska.jpg" alt="Teeth Whitening Procedure" />
              </div>
