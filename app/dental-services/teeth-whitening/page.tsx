      ...
      <section className={styles["service-page__content"]}>
        ...
        <aside className={styles["service-page__image-slider"]}>
          <div className={styles["slider__main-image"]}>
            <img src="/images/whitening1.jpg" alt="Teeth Whitening Procedure" />
          </div>
          <div className={styles["slider__thumbnails"]}>
            <div className={styles["thumbnail"]}>
              <img src="/images/whitening2.jpg" alt="Teeth Whitening Before and After" />
            </div>
            <div className={styles["thumbnail"]}>
              <img src="/images/whitening3.jpg" alt="Patient with Whiter Teeth" />
            </div>
          </div>
        </aside>
      </section>
